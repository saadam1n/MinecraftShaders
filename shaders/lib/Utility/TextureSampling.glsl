...
vec4 BicubicTexture(in sampler2D tex, in vec2 coord, int resolution = noiseTextureResolution)
{
...
vec4 BicubicTexture(in sampler2D tex, in vec2 coord, ivec2 resolution)
{
